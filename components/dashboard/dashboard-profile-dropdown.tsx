  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="relative flex items-center gap-2.5 h-10 px-2 rounded-xl hover:bg-slate-100 transition-colors cursor-pointer focus-visible:ring-1 focus-visible:ring-[#0056d2]"
        >
