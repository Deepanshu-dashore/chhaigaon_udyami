  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans text-slate-900">
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-gradient-to-tr from-emerald-200/40 to-teal-200/40 blur-3xl pointer-events-none rounded-full" />
          ...
          <div className="lg:col-span-6 space-y-6 hidden lg:block pr-4">
            ...
            <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm mt-6">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <div>
                  <h4 className="text-xs font-semibold text-slate-900 font-headline">
                    राजेश पटेल
                  </h4>
